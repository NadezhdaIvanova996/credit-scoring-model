...
# Полный список фичей (стандарт для датасета)
feature_names = [
...
dummy_input = pd.DataFrame(
    np.random.randn(1, num_features).astype(np.float32),
...
print("(Проверка inference отключена из-за особенностей ColumnTransformer — работает в API)")